...
class IrConfigParameter(models.Model):
    ...
    def set_default_s3_attachment_configuration_from_environment(self):
        ...
        s3_host_from_environment = os.getenv("AWS_HOST", "")
        s3_bucket_from_environment = os.getenv("AWS_BUCKET_NAME", "")
        s3_access_key_from_environment = os.getenv("AWS_ACCESS_KEY_ID", "")
        s3_secret_key_from_environment = os.getenv("AWS_SECRET_ACCESS_KEY", "")
